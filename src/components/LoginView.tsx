                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="Ingresa tu correo electrónico (ej: usuario@gmail.com)"
                      ...
                      <p className="text-[11px] text-slate-500 mt-1">
                        Se enviará un código de verificación de 6 dígitos a cualquier correo electrónico ingresado para restablecer la contraseña.
                      </p>
                    </div>
